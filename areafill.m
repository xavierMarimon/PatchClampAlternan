function[fillhandle,msg]=areafill(xpoints,upper,lower,color,edge,add,transparency)

%USAGE: [fillhandle,msg]=areafill(xpoints,upper,lower,color,edge,add,transparency)
...
%     [ph,msg]=areafill(x,a,b,rand(1,3),rand(1,3),0,rand(1,1))
%     grid on
%     legend('Datr')
